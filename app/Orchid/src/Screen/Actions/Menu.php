...
namespace App\Orchid\src\Screen\Actions;

use Modules\Tutorials\Models\Tutorial;
...
class Menu extends Link
{
    ...
    public function __construct()
    {
        $this
            ...
            ->addBeforeRender(function () {
                ...
                $this->set('active', isset($active) ? $active->toArray() : []);
            });
    }
     ...
     * @return $this
     */
    public function tutorial(string $tutorial): self
    {
        if (Tutorial::hasVideo($tutorial)) {
            $tutorialLink = Tutorial::getVideo($tutorial);
            return $this->url($tutorialLink);
        } else {
